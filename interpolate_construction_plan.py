...
tech_group_power_targets = (
    [[y, t, q, 'existing'] for i, y, t, q in existing_techs.itertuples()]
    + tech_group_power_targets
)
...
# don't interpolate if using HECO plan
if cmd_line_args.heco_plan:
...
for tg in interpolate_tech_groups:
    min_size = min_increment_size.get(tg, float('nan'))
